  ...
  const traders = await Promise.all([
    prisma.trader.create({
      data: {
        ...
        bio: 'Specializes in aggressive trading strategies with strict risk management. Focuses on momentum and trend-following setups.',
        linkedin: '#',
        twitter: '#',
        instagram: '#',
      },
    ...
    prisma.trader.create({
      data: {
        ...
        bio: 'Expert in pure price action analysis and market structure. Teaches traders to read raw market data without indicators.',
        linkedin: '#',
        twitter: '#',
        instagram: '#',
      },
    ...
    prisma.trader.create({
      data: {
        ...
        bio: 'Focuses on medium-term swing trades with higher timeframes. Patient approach to catching major market moves.',
        linkedin: '#',
        twitter: '#',
        instagram: '#',
      },
    ...
    prisma.trader.create({
      data: {
        ...
        bio: 'Specializes in portfolio risk management and position sizing. Helps traders protect capital while maximizing opportunities.',
        linkedin: '#',
        twitter: '#',
        instagram: '#',
      },
