        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/programs" className="text-sm text-muted hover:text-primary transition-colors">
                  Programs
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/risk-disclaimer" className="text-sm text-muted hover:text-primary transition-colors">
                  Risk Disclaimer
                </Link>
              </li>
              <li>
                <Link href="/refund-policy" className="text-sm text-muted hover:text-primary transition-colors">
                  Refund Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-sm text-muted mb-4">
              Get market insights and educational content delivered to your inbox.
            </p>
