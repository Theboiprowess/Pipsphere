        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted max-w-2xl mx-auto">
              Have questions about our programs or need support? We're here to help you on your trading journey.
            </p>
          </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted">support@pipsphere.com</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="text-2xl">💬</div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted">@pipsphere_support</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card p-6 rounded-xl border border-border">
                ...
                <p className="text-muted text-sm leading-relaxed">
                  We typically respond to all inquiries within 24-48 hours during business days. For urgent matters, please reach out via WhatsApp or Telegram.
                </p>
              </div>
            </div>
          </div>
