  ...
  const traders = [
    {
      ...
      specialty: 'High-Probability Trading',
      bio: 'Specializes in aggressive trading strategies with strict risk management. Focuses on momentum and trend-following setups. Known for high-probability trade identification and capital preservation techniques.',
      achievements: 'Developed aggressive trading strategies with proven risk management',
      linkedin: '#',
      twitter: '#',
      instagram: '#',
    },
    {
      name: 'KudzieFx',
      specialty: 'Price Action Trading',
      bio: 'Expert in pure price action analysis and market structure. Teaches traders to read raw market data without indicators. Focuses on clean chart analysis and market psychology.',
      achievements: 'Expert in pure price action, teaches traders to read raw market data',
      linkedin: '#',
      twitter: '#',
      instagram: '#',
    },
    {
      ...
      bio: 'Focuses on medium-term swing trades with higher timeframes. Patient approach to catching major market moves. Emphasizes patience and discipline in trading decisions.',
      achievements: 'Specializes in medium-term swing trades and higher timeframe analysis',
      linkedin: '#',
      twitter: '#',
      instagram: '#',
    },
    {
      ...
      bio: 'Specializes in portfolio risk management and position sizing. Helps traders protect capital while maximizing opportunities. Expert in risk-reward optimization and capital preservation.',
      achievements: 'Risk management expert, teaches capital preservation strategies',
      linkedin: '#',
      twitter: '#',
      instagram: '#',
    },
