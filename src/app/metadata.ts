...
export const siteMetadata: Metadata = {
  title: {
    default: 'Pipsphere - Master the Markets. Trade With Purpose.',
    template: '%s | Pipsphere'
  },
  ...
  openGraph: {
    ...
    url: '/',
    siteName: 'Pipsphere',
    title: 'Pipsphere - Master the Markets. Trade With Purpose.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Pipsphere - Forex Education Academy',
      },
    ],
  },
  twitter: {
